...
SELECT Numer, Cod, New, Name, Price, Sides FROM lab1.work;
...
SELECT Cod, Name, New, Sides, Price, Numer FROM lab1.work;
...
SELECT * FROM `lab1.work` HAVING RAND() > 0.9;
...
SELECT * FROM lab1.work WHERE (Sides >300 AND Sides< 400) AND (Price > 20 AND Price < 30);
...
SELECT * FROM lab1.work WHERE Name REGEXP '^[А-К]';
